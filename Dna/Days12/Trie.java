...
public class Trie {
    ...
    public void delete(String item) {
        Stack<HashMapX<Character,TrieNode>> nodes = new Stack<>();
        TrieNode curr = root;
        HashMapX<Character,TrieNode> kids = root.getChildren();
        for (int i = 0; i < item.length(); i++) {
            char c = item.charAt(i);
    ...
    public ArrayList<String> find(String partial) {
    ...
    private void walk(TrieNode curr, StringBuilder sb, ArrayList<String> words){
        if(curr.isWord())
